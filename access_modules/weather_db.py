...
def read_temperature(year=None, month=None, day=None):
    ...
    if year and month and not day:
        ...
        logger.debug('Executed SQL statement to read average temperature per day for month %s in year %s: %s' % (month, year, sqlstring))
    ...
    if year and month and day:
        ...
        logger.debug('Executed SQL statement to read temperature values for %s.%s.%s: %s' % (day, month, year, sqlstring))
...
def read_humidity(year=None, month=None, day=None):
    ...
    if year and month and not day:
        ...
        logger.debug('Executed SQL statement to read average humidity per day for month %s in year %s: %s' % (month, year, sqlstring))
...
def read_pressure(year=None, month=None, day=None):
    ...
    if year and month and not day:
        ...
        logger.debug('Executed SQL statement to read average pressure per day for month %s in year %s: %s' % (month, year, sqlstring))
