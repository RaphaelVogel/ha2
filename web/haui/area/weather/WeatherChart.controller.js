	...
	onInit: function() {
        ...
        this.getView().addEventDelegate({
            ...
            onBeforeShow: function(evt) {
				...
				if(this.isTemperatureChart()){
                    ...
                    weatherChart.bindRows("/temp_data")
                }
                    ...
                    weatherChart.bindRows("/humidity_data")
                }
                    ...
                    weatherChart.bindRows("/pressure_data")
                }
            }
        }, this);
        ...
        weatherChartModel.attachRequestCompleted(function(req){
            if(req.getParameters().url.indexOf("historicTemperatures") > -1){
                ...
                .setMin((that.getView().byId("weatherChart").getModel().getProperty("/min")).toString())
                .setMax((that.getView().byId("weatherChart").getModel().getProperty("/max")).toString());
            }
